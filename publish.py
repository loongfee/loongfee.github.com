...
os.system('git remote add origin git@github.com:%s/%s.github.com.git'%(usr,usr))
os.system('git remote set-url origin git@github.com:%s/%s.github.com.git'%(usr,usr))
